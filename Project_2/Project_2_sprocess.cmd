...
# Project 2 : 180 nm 2D nMOS — FULL STRUCTURE (with reflect)
#
# Identical to Project 1 except the final save uses:
#     transform reflect left
#     struct tdr= n@node@_fps
# which mirrors the half-cell to produce the complete symmetric device.
###########################################################################
...
###########################################################################
# SECTION 5 : Polysilicon Reoxidation
###########################################################################
...
###########################################################################
# SECTION 12 : Electrical Contact Definitions (for sdevice)
###########################################################################

contact name= substrate bottom
contact name= source   point y= 0.0     x= -0.02<um>
contact name= drain    point y= 0.3<um> x= -0.02<um> replace
